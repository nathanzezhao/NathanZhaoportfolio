...
void main() {
  ...
  if (uDispersion > 0.001) {
    ...
    color.g = sampleImage(base + push).g;
    color.b = sampleImage(base + push * (1.0 - split)).b;
  } else {
    color = sampleImage(base + push);
  }
...
const CtaRipple = ({
  ...
  return <div ref={mountRef} className={`cta-ripple ${className}`.trim()} style={style} />;
};

export default CtaRipple;
