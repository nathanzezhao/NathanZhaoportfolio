...
void main() {
  ...
  fragColor = vec4(chrome * glass, glass);
}
`;
...
const LayerRipple = ({
  ...
  useEffect(() => {
    ...
    compositeMesh.program.setBlendFunc(gl.ONE, gl.ONE_MINUS_SRC_ALPHA);
  ...
  return <div ref={mountRef} className={`layer-ripple ${className}`.trim()} style={style} />;
};

export default LayerRipple;
