...
vec3 sampleImage(vec2 uv) {
  ...
  return textureLod(uTexture, clamped, 0.0).rgb;
}
...
const BrickRipple = ({
  ...
  return <div ref={mountRef} className={`brick-ripple ${className}`.trim()} style={style} />;
};

export default BrickRipple;
