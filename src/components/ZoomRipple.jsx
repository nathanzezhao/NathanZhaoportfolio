...
vec2 fitUV(vec2 uv) {
  ...
  vec2 scaledSize = safe * min(s.x, s.y) * 0.84;
...
const ZoomRipple = ({
  ...
  return <div ref={mountRef} className={`zoom-ripple ${className}`.trim()} style={style} />;
};

export default ZoomRipple;
