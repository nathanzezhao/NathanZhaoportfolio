...
vec2 fitUV(vec2 uv) {
  ...
  vec2 scaledSize = safe * min(s.x, s.y) * 0.94;
...
const SideRipple = ({
  ...
  return <div ref={mountRef} className={`side-ripple ${className}`.trim()} style={style} />;
};

export default SideRipple;
