...
void main() {
  ...
  float scan = mix(0.62, 1.0, step(1.0, mod(floor(vUv.y * uResolution.y), 2.0)));
  color *= scan;
...
const ScanRipple = ({
  ...
  return <div ref={mountRef} className={`scan-ripple ${className}`.trim()} style={style} />;
};

export default ScanRipple;
